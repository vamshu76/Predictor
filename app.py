...
with col1:
    ...
    cement = st.number_input('Cement (0.23 to 1.26)', min_value = 0.23, max_value = 1.26)
    fly_ash = st.number_input('Fly Ash C (0 to 4.4)', min_value = 0.0, max_value = 4.4)
    sand2 = st.number_input('Sand Zone 2 (0 to 6.9)', min_value = 0.0, max_value = 6.9)
    sand3 = st.number_input('Sand Zone 3 (0 to 6.9)', min_value = 0.0, max_value = 6.9)
    ...
    w_b = st.number_input('Water/Binder (0 to 3.6)', min_value = 0.0, max_value = 3.6)
    sp = st.number_input('Superplasticizer (0 to 16.85)', min_value = 0.0, max_value = 16.85)
with col2:
